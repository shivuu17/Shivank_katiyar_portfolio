              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-center">
                <div className="space-y-3 sm:space-y-4 md:col-span-2">
                  <div className="space-y-2">
                    ...
                    <div className="pl-2 sm:pl-4 space-y-2 sm:space-y-3 text-sm sm:text-lg md:text-xl">
                ...
                >
                  <div className="relative w-full max-w-[240px] h-96 sm:max-w-[260px] sm:h-[420px]">
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-green-500/20 rounded-lg blur-xl" />
                    <img
